    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-400 via-pink-500 to-red-500">
      ...
      <div className="flex items-center justify-center min-h-[80vh]">
        <div className="text-center max-w-4xl mx-auto px-4 sm:px-8">
          ...
          <a 
            href="/create"
            className="inline-flex items-center gap-2 sm:gap-3 px-8 sm:px-12 py-4 sm:py-6 bg-yellow-400 text-purple-800 font-bold rounded-xl sm:rounded-2xl text-lg sm:text-xl hover:bg-yellow-300 transition-all duration-300 hover:scale-105 shadow-2xl mx-4 no-underline"
          >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-8 mt-12 sm:mt-16 max-w-4xl mx-auto px-4">
            ...
            <div className="bg-white/10 rounded-2xl p-4 sm:p-6 border border-white/20 backdrop-blur-sm">
              <div className="text-3xl sm:text-4xl mb-3 sm:mb-4">🎨</div>
              <h3 className="text-lg sm:text-xl font-bold text-white mb-2">Real Image Generation</h3>
          ...
          <div className="mt-12 sm:mt-16 px-4">
            ...
            <a 
              href="/create"
              className="inline-flex items-center gap-2 px-6 sm:px-8 py-3 bg-white/20 text-white font-semibold rounded-xl hover:bg-white/30 transition-colors border border-white/30 no-underline"
            >
              <span>🚀</span>
